...
import algoliaLogo from '../img/search-by-algolia-white.svg';
                        ...
                        <div className="container">
							...
							{ (this.state.results.length > 0 || this.state.error) ? '' :
								<div className="search-extra">
									<Link id="search-help" className="help-text is-pulled-left" to="/about">What is this?</Link> 
									<img src={algoliaLogo} className="algolia-logo is-pulled-right" alt="Search by Algolia" />
								</div>
							}
							...
							{ (this.state.results.length === 0 && !this.state.error) ? '' :
								<img src={algoliaLogo} className="algolia-logo is-centered list-footer" alt="Search by Algolia" />
							}
                        </div>
                    </div>
                </section>
